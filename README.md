...
## How to Use
1. Download the `zoom-auto-restarter.exe` from the Releases tab.
2. Run the program.
3. Paste your Zoom link when prompted.
...
```bash
git clone https://github.com/Binukape/zoom-auto-restarter.git
